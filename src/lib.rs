...
#[derive(Debug)]
pub struct TextileHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TextileHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TextileHub processing");
    
    let mut processor = TextileHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TextileHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TextileHubProcessor::new(false);
